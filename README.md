...
```typescript
const brice = {
  location: "Saint-Lô, Normandy 🇫🇷",
  education: "BUT MMI - Web Development",
  focus: "Game Development",
  languages: ["French (Native)", "English (B2+ - TOEIC 870)"],
  currentlyWorking: ["Mirror Soul!", "Culturia Quests"],
  lookingFor: "Game Development Opportunities"
};
```
...
WordPress/WooCommerce solutions for various clients.
...
**Fullstack Developer Intern** | Minimal Roleplay (2 months)  
Developed tabletop RPG platform features using internal Napi framework (Nuxt.js-based) and Strapi.

**Freelance Web Developer** | Self-Employed  
WordPress/WooCommerce e-commerce solutions for various clients.
...
![Brice's GitHub stats](https://github-readme-stats.vercel.app/api?username=Skycun&show_icons=true&theme=radical)
  
[![Top Langs](https://github-readme-stats.vercel.app/api/top-langs/?username=Skycun&layout=compact&theme=radical)](https://github.com/anuraghazra/github-readme-stats)
